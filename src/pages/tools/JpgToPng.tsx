  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-12 space-y-8">
      <div className="space-y-2 text-center">
        <h1 className="text-4xl font-bold">JPG to PNG</h1>
        <p className="text-white/60">Convert JPG images to high-quality PNG format instantly.</p>
      </div>
      ...
      <div className="space-y-8">
        {!file ? (
          <label className="glass rounded-[40px] border-2 border-dashed border-white/10 hover:border-primary/50 transition-all cursor-pointer flex flex-col items-center justify-center p-24 group">
            ...
            <h3 className="text-2xl font-bold mb-2">Drop your JPG here</h3>
            ...
            <div className="flex flex-col md:flex-row gap-8 items-center">
              ...
              <div className="w-full md:w-1/2 space-y-6">
                ...
                >
                  ...
                  {isProcessing ? 'Converting...' : 'Convert & Download PNG'}
                </button>
