  ...
  return (
    <div className="max-w-5xl mx-auto px-6 py-12 space-y-8">
      <div className="space-y-2">
        <h1 className="text-3xl font-bold">WebP to JPG</h1>
        <p className="text-white/60">Convert WebP images to JPG for better compatibility with older software.</p>
      </div>
          ...
          {resultBlob && (
            ...
            >
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="flex justify-between">
                  <span className="text-white/40">JPG:</span>
        ...
        <div className="lg:col-span-2 space-y-6">
          {!file ? (
            <SmartDropzone
              ...
              description="Drop your WebP file here"
            />
          ) : (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-3">
                <p className="text-sm font-medium text-white/40 px-2">Original WebP</p>
              ...
              <div className="space-y-3">
                <p className="text-sm font-medium text-white/40 px-2">JPG Preview</p>
